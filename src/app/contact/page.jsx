...
export const metadata = {
  ...
  description: "Welcome to my Contact Page",
};
const ContactPage = () => {
        ...
        <div className="content">
          <form action="">
            <div className="group mb-[1rem] flex flex-col gap-[.3rem]">
              ...
              <input
                className="py-3 px-5 border-none outline-none bg-[#ffffff14] rounded-sm"
                type="text"
            ...
            <textarea
              className="w-full mt-[.5rem] resize-none py-3 px-5 border-none outline-none bg-[#ffffff14] rounded-sm"
              rows="5"
              placeholder="Your Message"
            ></textarea>
            <button className="w-full mt-[1rem] rounded-sm bg-[#8831c6] py-3">
              Send
            </button>
          </form>
        </div>
